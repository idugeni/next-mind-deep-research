      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
        <Card className="transition-all duration-300 hover:shadow-lg hover:bg-accent/50">
          <CardContent className="p-6 space-y-2 flex flex-col items-center">
            <Search className="h-8 w-8 text-primary mb-2 transition-transform duration-300 hover:translate-y-1" />
        ...
        <Card className="transition-all duration-300 hover:shadow-lg hover:bg-accent/50">
          <CardContent className="p-6 space-y-2 flex flex-col items-center">
            <Brain className="h-8 w-8 text-primary mb-2 transition-transform duration-300 hover:translate-y-1" />
        ...
        <Card className="transition-all duration-300 hover:shadow-lg hover:bg-accent/50">
          <CardContent className="p-6 space-y-2 flex flex-col items-center">
            <FileText className="h-8 w-8 text-primary mb-2 transition-transform duration-300 hover:translate-y-1" />
